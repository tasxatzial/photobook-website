...
* Able to verify current location ([Nominatim](#dependencies)).
* See a verified location on the map ([Openlayers](#dependencies)).
* Automatic fill in of the country, city, address fields (HTML5 Geolocation + [Nominatim](#dependencies)).
* Option to associate a username to a face photo ([Face++](#dependencies)).

### Sign in screen

* Automatic fill in of the username using a face photo ([Face++](#dependencies)).
* Show an appropriate message if the face photo shows any emotion ([Face++](#dependencies)).
